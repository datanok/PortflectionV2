...
type ExtendedPortfolioFormData = any; // Simplified for now since we're removing old forms

export const generateDummyPortfolioData = (
  type: PortfolioType
): ExtendedPortfolioFormData => {
  const baseData: Partial<any> = {
    name: "Tanmay Patil",
    ...
    experience: [
      {
        ...
        current: true,
        description:
          "Building high-performance, scalable web applications for enterprise platforms serving millions of users",
        achievements: [
          ...
          "Implemented JWT-based authentication with single-device login, reducing unauthorized access incidents by 95%",
          ...
          "Designed React.js-based digital logbook replacing manual tracking for 20+ machines, processing 20M+ SIM kits annually, reducing data entry time by 40%",
          "Delivered real-time dashboards improving visibility and reducing operator onboarding time by 25%",
          "Refactored 3,000+ lines to ES6+, boosting performance and Lighthouse scores by 30%. Introduced reusable component library, speeding feature delivery by 30%",
        ],
      },
    ],
    education: [
        ...
        portfolioItems: [
          {
            ...
            challenges:
              "Implementing secure payment processing and scalability",
            learnings:
              "Gained experience with payment gateway integration and AWS deployment",
          },
          {
            ...
            learnings:
              "Deepened Firebase real-time database and offline caching knowledge",
          },
          {
        ...
        portfolioItems: [
          {
            ...
            description:
              "Complete redesign of mobile banking experience focusing on usability.",
            ...
            outcome:
              "Increased user retention by 40%, improved task success rate by 25%",
            images:
          ...
          },
          {
            ...
            process:
              "User research, persona creation, prototyping, A/B testing",
            ...
            testimonial: {
              ...
              content:
                "Outstanding design that improved user engagement dramatically.",
            },
          },
        ],
        testimonials: [
      ...
      return {
        ...
        portfolioItems: [
          {
            ...
            type: "Video",
            description:
              "Comprehensive tutorial series on React fundamentals for beginners",
          ...
          },
          {
            ...
            type: "Writing",
            description:
              "In-depth article exploring advanced CSS features like Grid, Flexbox, and variables",
          ...
          },
          {
            ...
            type: "Podcast",
            description:
              "A podcast episode discussing essential photography tips for content creators",
        ...
        pricingPackages: [
          ...
          },
          {
            ...
            price: "$1200",
            description:
              "Includes up to 10 minutes of video with advanced editing and motion graphics",
            features: [
              "Scriptwriting",
              "Advanced editing",
        ...
        portfolioItems: [
          {
            ...
            solutions:
              "Phased rollout with extensive staff training and support",
            outcomes:
              "30% increase in operational efficiency and 15% sales growth",
            teamSize: 8,
            keyMetrics: [
          ...
          },
          {
            ...
            solutions:
              "Comprehensive competitor analysis and regulatory compliance plan",
        ...
        keyAchievements: [
          {
            ...
            description:
              "Identified and implemented cost-saving measures across multiple clients",
            impact: "Improved clients' bottom line by an average of 15%",
          },
          {
            title: "Market Expansion Success",
            description:
              "Led strategies that enabled clients to enter 3 new international markets",
