...
export const Footer = ({ name, theme, showScrollTop, onScrollTop }: FooterProps) => {
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mt-8 pt-8 border-t text-center" style={{ borderColor: theme.border }}>
          <p className="text-sm" style={{ color: theme.bodySecondary }}>
            Made with <Heart className="inline w-4 h-4 text-red-500" /> using Next.js and Tailwind CSS
          </p>
        </div>
      </div>
