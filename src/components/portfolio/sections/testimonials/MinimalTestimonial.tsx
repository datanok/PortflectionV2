                        ...
                        >
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    ...
                                    <p
                                        className={`text-base leading-relaxed text-left ${showQuotes ? 'inline' : ''}`}
                                        style={{ color: textColor }}
                                    >
                                        {testimonial.content}
                                    </p>
                                    ...
                                    <div className="flex justify-end items-center mt-3 gap-1">
                                        {[1, 2, 3, 4, 5].map((star) => (
                                            <svg
                                                key={star}
                                                className="w-4 h-4"
                                                fill={star <= testimonial.rating! ? primaryColor : 'none'}
                                                stroke={star <= testimonial.rating! ? primaryColor : secondaryColor}
                                                strokeWidth="1"
                                                viewBox="0 0 24 24"
                                            >
                                                <path
                    ...
                    {testimonials.map((_, index) => (
                        <button
                            ...
                            style={{
                                ...
                                height: "8px",
                                backgroundColor: index === currentIndex ? primaryColor : `${secondaryColor}60`,
                            }}
                            onMouseEnter={(e) => {
