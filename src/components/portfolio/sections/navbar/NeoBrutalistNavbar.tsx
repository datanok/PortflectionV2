...
const NeoBrutalistNavbar: React.FC<ComponentProps> = ({
  ...
  const navbarStyles = {
    ...
    boxShadow: isScrolled ? shadow : `3px 3px 0px ${borderColor}`,
  ...
  return (
    <>
      ...
      <div className="relative top-0 left-0 right-0 z-50 pt-4">
        <nav
          className={cn(
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `2px solid ${
                        isActive || isHovered ? borderColor : "transparent"
                      }`,
                      borderRadius: `${borderRadius}px`,
                      boxShadow: isActive
                        ? shadow
                        : isHovered
                        ? `2px 2px 0px ${borderColor}`
                        : "none",
                      transform:
                        isHovered && !isActive
                          ? "translate(-1px, -1px)"
      ...
      {showMobileMenu && (
        ...
        >
          ...
          >
            <p
              className="font-mono text-sm uppercase tracking-wider opacity-60"
              style={{ color: textColor }}
            >
              BRUTALIST_UI.EXE
            </p>
